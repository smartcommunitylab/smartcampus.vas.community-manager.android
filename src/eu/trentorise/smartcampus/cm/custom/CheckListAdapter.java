...
public class CheckListAdapter extends
	...
	public CheckListAdapter(Context context, LayoutInflater layoutInflater,
			int layoutResourceId) {
	...
	public CheckListAdapter(Context context, LayoutInflater layoutInflater,
			int layoutResourceId, CheckListItem[] values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			...
			// row.findViewById(R.id.checklist_checkBox);
			// holder.optionTextView = (TextView)
			// row.findViewById(R.id.checklist_textView);
			//
			// row.setTag(holder);
			// } else {
